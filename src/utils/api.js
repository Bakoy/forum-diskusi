const api = (() => {
  ...
  async function upVoteComment({ idThread, idComment }) {
    const response = await _fetchWithAuth(`${BASE_URL}/threads/${idThread}/comments/${idComment}/up-vote`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function downVoteComment({ idThread, idComment }) {
    const response = await _fetchWithAuth(`${BASE_URL}/threads/${idThread}/comments/${idComment}/down-vote`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
